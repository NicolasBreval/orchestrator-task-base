...
@Suppress("UNUSED")
@Prototype
@Named("SCRIPTABLE-CONSUMER")
class ScriptableConsumer(
    @Parameter
    name: String,
    @Parameter
    parameters: Map<String, Any>,
    applicationContext: ApplicationContext
): ConsumerTask<ScriptableConsumerTaskParameters, String>(name, parameters, ScriptableConsumerTaskParameters::class.java, applicationContext) {
